...
################create folders
def script_1(table_name,localhost,user,password,db_name):
...
script_1(table_name,localhost,user,password,db_name)
#script_("2m","localhost","root","epg2018.AfrDR12535754823","2m")
